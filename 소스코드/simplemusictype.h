#ifndef SIMPLEMUSICTYPE_H
#define SIMPLEMUSICTYPE_H
...
public:
    ...
    *	@post	가수 이름이 출력된다.
    */
    string DisplaySimpleSongArtist();
    ...
    *	@post	곡 정보가 출력된다.
    */
    string DisplaySimpleSongRecord();
    ...
    *	@post	곡 재생횟수가 출력된다.
    */
    string DisplaySimpleSongPlayedTime();
